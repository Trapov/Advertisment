...
namespace Advertisement.Application.Services.User.Contracts.Exceptions
{
    ...
    {
        private const string MessageTemplateForUserId = "Пользователя таким ID[{0}] не было найдено.";
        private const string MessageTemplateForUserName = "Пользователя таким именем [{0}] не было найдено.";
